...
<label for="card-element">
  ...
  <input type="hidden" name="code_post" value="{{ $data['code_post'] }}">
...
var stripe = Stripe('pk_test_51MBCT4LRyAGjJ7domWNIUdhRgjGxGKhOCI7pJQhRcEgR0j5W37uey5nTSy1NUUrJQTldMrAyF2OtUMXzPR9WXD3s00YLmG1Yvs');
