...
@section('title')
@if (session()->get('lang') == 'en') Buy 1 Get Zero  @else Beli 1 dapet Kosong hehe @endif
...
<div class="body-content outer-top-xs" id="top-banner-and-menu">
        ...
        <div class="col-xs-12 col-sm-12 col-md-3 sidebar"> 
          ...
          <div class="sidebar-widget outer-bottom-small wow fadeInUp">
            <h3 class="section-title">
              @if (session()->get('lang') == 'en') Special Offer @else Penawaran Khusus @endif
            </h3>
                        ...
                        <div class="row product-micro-row">
                          <div class="col col-xs-5">
                            <div class="product-image">
                              <div class="image"> <a href="{{ url('product/details/'.$product->id.'/'. $product->product_slug_ind) }}"> <img src="{{ asset($product->product_thumbnail) }}" alt=""> </a> </div>
                              <!-- /.image --> 
                          ...
                          <div class="col col-xs-7">
                            <div class="product-info">
                              ...
                              <div class="product-price"> <span class="price"> Rp.{{ $product->selling_price - $product->discount_price }} </span> </div>
                              <!-- /.product-price --> 
          ...
          <div class="sidebar-widget outer-bottom-small wow fadeInUp">
            <h3 class="section-title">
              @if (session()->get('lang') == 'en') Special Deals @else Penawaran Istimewa @endif
            </h3>
            <div class="sidebar-widget-body outer-top-xs">
              <div class="owl-carousel sidebar-carousel special-offer custom-carousel owl-theme outer-top-xs">
          ...
          <!-- ============================================== Testimonials============================================== -->
          @include('frontend.common.testimoni')
          ...
          <div id="product-tabs-slider" class="scroll-tabs outer-top-vs wow fadeInUp">
            <div class="more-info-tab clearfix ">
              <h3 class="new-product-title pull-left">
                @if (session()->get('lang') == 'en') New Products @else Produk Terbaru @endif</a> </li>  
              </h3>
    ...
    {{-- ============================================================PANEL==================================================================== --}}
            ...
            <div class="product-info text-left">
              <h3 class="name"><a href="{{ url('product/details/'.$product->id.'/'. $product->product_slug_ind) }}">
                @if (session()->get('lang') == 'en') {{ Str::limit($product->product_name_en,50) }} @else {{ Str::limit($product->product_name_ind,50) }} @endif  </a> </li>
              </a></h3>
              <div class="rating rateit-small"></div>
              <div class="description"></div>
              <div class="product-price"> <span class="price">Rp.{{ $product->selling_price - $product->discount_price }} </span> <span class="price-before-discount">
...
{{-- ============================================================PANEL==================================================================== --}}
            ...
            <div class="product-info text-left">
              ...
              <div class="rating rateit-small"></div>
              <div class="description"></div>
              <div class="product-price"> <span class="price"> Rp.{{ $product->selling_price }} </span> <span class="price-before-discount">
            ...
            <div class="cart clearfix animate-effect">
              ...
              <!-- /.action --> 
                    ...
                    @else
                    <h5 class="text-danger">@if (session()->get('lang') == 'en') No Product Found @else Produk Kategori ini kosong @endif</h5>
                    @endif
          ...
          <section class="section featured-product wow fadeInUp">
            <h3 class="section-title">
              @if (session()->get('lang') == 'en') Featured products @else Fitur Produk @endif
            </h3>
      ...
      <div class="cart clearfix animate-effect">
        ...
        <!-- /.action --> 
          ...
          <section class="section featured-product wow fadeInUp">
            <h3 class="section-title">
              @if (session()->get('lang') == 'en') {{ $skip->category_name_en }}@else {{ $skip->category_name_ind }} @endif
            </h3>
            <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">
              @foreach ($category_pilih as $product)
      ...
      <div class="cart clearfix animate-effect">
        ...
        <!-- /.action --> 
          ...
          <!-- ============================================== Costum Category 1 : END ============================================== --> 
           ...
           <section class="section featured-product wow fadeInUp">
            <h3 class="section-title">
              @if (session()->get('lang') == 'en') {{ $skip1->category_name_en }}@else {{ $skip1->category_name_ind }} @endif
            </h3>
            <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">
              @foreach ($category_pilih1 as $product)
        ...
        <!-- /.action --> 
          ...
          <!-- ============================================== BEST SELLER ============================================== -->
             ...
             <section class="section featured-product wow fadeInUp">
              ...
              <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">
                @foreach ($brand_pilih1 as $product)
