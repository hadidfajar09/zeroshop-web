                        ...
                        <div class="row product-list-row">
                          ...
                          <div class="col col-sm-8 col-lg-8">
                            <div class="product-info">
                              <h3 class="name"><a href="{{ url('product/details/'.$product->id.'/'. $product->product_slug_ind) }}">
                                @if (session()->get('lang') == 'en') {{$product->product_name_en }} @else {{ $product->product_name_ind }} @endif
                              </a></h3>
                              <div class="rating rateit-small"></div>
                              <div class="product-price"> <span class="price"> 
                                Rp.{{ $product->selling_price - $product->discount_price }}
                              ...
                              <div class="description m-t-10">
                                @if (session()->get('lang') == 'en') {{ Str::limit($product->short_desc_en,150) }} @else {{ Str::limit($product->short_desc_ind,150) }} @endif
                              </div>
                              <div class="cart clearfix animate-effect">
                                <div class="action">
                                  <ul class="list-unstyled">
