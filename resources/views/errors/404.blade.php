...
<head>
  <meta charset="utf-8">
    ...
    <title>ZeroShop - 404 Not Found</title>
		  ...
		  <div class="row h-p100 align-items-center justify-content-center text-center">
			  <div class="col-lg-7 col-md-10 col-12">
				  <div class="b-double border-white rounded30">
					  ...
					  <h3 class="text-white">Lu Cari apa cok</h3>
					  <div class="my-30"><a href="{{ url('/') }}" class="btn btn-danger btn-rounded">Back to dashboard</a></div>				  
